...
NAME=mupdf
VERSION=1.22.
URL=https://www.mupdf.com/downloads/archive/mupdf-1.22.0-source.tar.gz
SECTION="PostScript"
...
wget -nc https://www.mupdf.com/downloads/archive/mupdf-1.22.0-source.tar.gz
...
make prefix=/usr                        \
     shared=yes                         \
     docdir=/usr/share/doc/mupdf-1.22.0 \
     install                            &&
