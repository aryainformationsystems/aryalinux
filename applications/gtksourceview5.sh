...
wget -nc https://download.gnome.org/sources/gtksourceview/5.8/gtksourceview-5.8.0.tar.xz
wget -nc ftp://ftp.acc.umu.se/pub/gnome/sources/gtksourceview/5.8/gtksourceview-5.8.0.tar.xz
