...
wget -nc https://download.gnome.org/sources/tracker-miners/3.4/tracker-miners-3.4.3.tar.xz
wget -nc ftp://ftp.acc.umu.se/pub/gnome/sources/tracker-miners/3.4/tracker-miners-3.4.3.tar.xz
