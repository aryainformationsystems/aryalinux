...
NAME=python-dependencies#sc-serializinghtml
VERSION=1.1.5
URL=https://files.pythonhosted.org/packages/source/s/sphinxcontrib-serializinghtml/sphinxcontrib-serializinghtml-1.1.5.tar.gz
SECTION="Others"
