...
wget -nc https://www.lua.org/ftp/lua-5.2.4.tar.gz
wget -nc https://raw.githubusercontent.com/aryainformationsystems/patches/1.0/lua-5.2.4-shared_library-1.patch
