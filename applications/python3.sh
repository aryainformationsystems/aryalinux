...
wget -nc https://www.python.org/ftp/python/3.11.3/Python-3.11.3.tar.xz
wget -nc https://www.python.org/ftp/python/doc/3.11.3/python-3.11.3-docs-html.tar.bz2
...
sudo rm -rf /tmp/rootscript.sh
cat > /tmp/rootscript.sh <<"ENDOFROOTSCRIPT"
ln -svfn python-3.11.3 /usr/share/doc/python-3
ENDOFROOTSCRIPT
